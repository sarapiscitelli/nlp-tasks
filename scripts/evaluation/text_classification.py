...
from nlp_inference.encoder.inference_text_classification import evaluation
...
results_dir = Path(__file__).parent.parent.parent / "results" / \
    "text_classification" / "eval" / f"exp_{date}"
print(f"Results directory: {results_dir}")

### START CONFIGURATION PARAMETERS ###
dataset: Dataset = get_imdb_dataset()['test']
text_feat: str = "text"
label_feat: str = "label"
...
def start_evaluation(model_name_or_checkpoin_path: str):
    ...
    evaluation_metrics: Dict[str, Any] = evaluation(texts=dataset_filtered[text_feat],
                                              labels_texts=dataset_filtered[label_feat],
